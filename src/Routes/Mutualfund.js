                    ...
                    <Col className="" lg='3' md='3' sm='12' xs='12'>
                        <Row>
                            <Col lg='12' className="pt-3">
                                ...
                                <Link to={'/MutualFund'} className="services1 mt-2 mb-2 py-2 ps-2" >Mutual Funds<span className="arrow"><BsArrowRight/></span></Link>
                            </Col >
                    ...
                    <Col className="" lg='9' md='9' sm='12' xs='12'>
                        <Row>
                            ...
                            <Col lg='12' className="p-5 pt-3 ">
                                <h3 className="loan-head">Mutual Funds</h3>
                                <p className="text-secondary aboutus-desc mt-3" >Mutual funds are an easy, 
                                convenient way to invest, without having to worry about choosing individual stocks. 
                                A mutual fund can be defined as a single portfolio of stocks, bonds, and/or cash managed 
                                by an investment company on behalf of many investors. The investment company manages the fund, 
                                and sells shares in the fund to individual investors. When one invests in a mutual fund, 
                                they become a part-owner of a large investment portfolio, along with all the other shareholders
                                 of the fund. The fund manager invests 
                                the contributions when shares are purchased, along with money from the other shareholders.</p>
                            </Col>
                        </Row>
                    </Col>
                </Row>
