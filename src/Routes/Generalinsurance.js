                    ...
                    <Col className="" lg='3' md='3' sm='12' xs='12'>
                        <Row>
                            <Col lg='12' className="pt-3">
                                ...
                                <Link to={'/Generalinsurance'} className="services1 mt-2 mb-2 py-2 ps-2">General Insurance<span className="arrow"><BsArrowRight/></span></Link>
                    ...
                    <Col className="" lg='9' md='9' sm='12' xs='12'>
                        <Row>
                            ...
                            <Col lg='12' className="p-5 pt-3 ">
                                <h3 className="loan-head">General Insurance</h3>
                                <p className="text-secondary aboutus-desc" >General insurance is an agreement between a policyholder and insurer wherein the insurance company protects your valuable assets from fire, theft, burglary, or any other unfortunate accident.
                                </p>
                               <h5>We are partner with</h5>
                               <ul className="mt-3">
                                <li className="text-secondary">ICICI Lombard</li>
                                <li className="text-secondary">HDFC ERGO</li>
                                <li className="text-secondary">Go Digit</li>
                                <li className="text-secondary">CARE</li>
                               </ul>
                            </Col>
                        </Row>
                    </Col>
