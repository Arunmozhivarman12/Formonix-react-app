                    ...
                    <Col className="" lg='3' md='3' sm='12' xs='12'>
                        <Row>
                            <Col lg='12' className="pt-3">
                                ...
                                <Link to={'/Businessloan'} className="services1 mt-2 mb-2 py-2 ps-2">Business Loan<span className="arrow"><BsArrowRight/></span></Link>
                    ...
                    <Col className="" lg='9' md='9' sm='12' xs='12'>
                        <Row>
                            ...
                            <Col lg='12' className="p-5 pt-3 ">
                                <h3 className="loan-head">Business Loan</h3>
                                <p className="text-secondary aboutus-desc" >Every business needs funding 
                                at some point, regardless of its size or nature. You can use a business loan 
                                to meet the urgent financial needs of your growing business. If you want to expand 
                                your business, you can apply for a business loan. The business will be able
                                 to increase production, go online, acquire inventory, buy equipment, and so on. 
                                 Our online business loan application can be completed from the comfort of your home
                                  or office. Don't worry about endless paperwork or running from pillar to post. You can also choose the 
                                timeframe in which you wish to repay your business loan.
                                </p>
                                <p className="text-secondary aboutus-desc" >
                                Our business loans come with various charges, such as processing fees, foreclosure charges, EMI bounce charges, 
                                etc., which will all be disclosed during the loan application process.</p>
                            </Col>
                        </Row>
                    </Col>
                </Row>
